...
<head>
  ...
  <link
    ...
    rel="stylesheet">
  <title>Donate Masks - Nursing Home Mask Initiative</title>
        ...
        @if(count($errors) > 0)
          <script>
              Swal.fire({
                  ...
                  showClass: {
                      popup: "animate_animated animate_fadeIn animate__faster "
                  },
                  hideClass: {
                      popup: "animate_animated animate_fadeOut animate__faster"
                  },
