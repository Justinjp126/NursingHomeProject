...
/**
 * Uses PHPMailer to send message
 */
const sendEmail = () => {
    var name = $("#enterName__form");
    var email = $("#enterEmail__form");
    var message = $("#enterMessage__form");
    ...
    /**
     * Verifies all fields have content
     * @param {*} caller Name, Email, or Message
     */
